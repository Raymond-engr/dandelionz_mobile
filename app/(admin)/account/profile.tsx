...
export default function AdminProfileScreen() {
  ...
  const { data: profileResponse, isLoading, refetch } = useGetAdminProfileQuery();
  ...
  return (
    ...
    >
      ...
      <View className="flex-row items-center justify-between px-4 py-4 border-b border-gray-100">
        ...
        <Text className="text-[18px] font-bold text-system-blue-dark text-center flex-1">
          My Profile
        </Text>
        <View className="w-10" />
      </View>
        ...
        <View className="p-[21px]">
          ...
          <View className="flex-row items-center gap-4 mb-8">
            ...
            <View>
              ...
              <Text className="text-[14px] text-gray-500">{formData.email}</Text>
            </View>
          </View>
          ...
          <View className="gap-6 mb-8">
            ...
            <View>
              ...
              <TouchableOpacity onPress={() => router.push("/(admin)/account/change-password" as any)}>
                <Text className="text-system-blue-light font-bold mt-2">Change Password</Text>
              </TouchableOpacity>
            </View>
          </View>
          ...
          <View className="gap-4">
            {!isEditing ? (
              ...
              <>
                ...
                >
                  <Text className="text-gray-500 font-bold">Discard Changes</Text>
                </TouchableOpacity>
              </>
            )}
          </View>
