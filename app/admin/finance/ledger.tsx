        ...
        <FlatList
          ...
          ListHeaderComponent={
            <View className="mb-4">
                ...
                <View className="flex-row justify-between mb-3">
                  <View className="flex-1">
                    ...
                    <Text className="text-[16px] font-bold text-green-600 mt-0.5">
                      {summary
                        ? formatCurrency(Number(summary.total_credits))
                        : "—"}
                    </Text>
                  </View>
                  <View className="flex-1">
                    ...
                    <Text className="text-[16px] font-bold text-red-600 mt-0.5">
                      {summary
                        ? formatCurrency(Number(summary.total_debits))
                        : "—"}
                    </Text>
                  </View>
                </View>
              ...
              <TouchableOpacity
                onPress={() =>
                  router.push("/admin/finance/failed-payments" as any)
                }
