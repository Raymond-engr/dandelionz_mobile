      ...
      <View className="flex-1 bg-white" style={{ paddingTop: insets.top }}>
        ...
        >
          ...
          <View className="bg-system-blue-light rounded-[16px] p-8 mt-6 mb-8 shadow-lg shadow-blue-900/20">
            <Text className="text-white/80 text-[14px] font-medium mb-2 uppercase tracking-widest">
              Available Balance
            </Text>
          ...
          <View className="bg-gray-50/50 rounded-[16px] p-6 border border-gray-100">
            ...
            <View className="flex-row justify-between py-2">
              ...
              <Text className="font-bold text-system-blue-dark text-right flex-1 ml-4">
            ...
            >
              ...
              <Text className="text-system-blue-light font-bold">
                Edit Bank Details
              </Text>
            </Pressable>
          </View>
          ...
          {!payment?.has_pin && (
            <View className="mt-8 bg-yellow-50 p-4 rounded-[12px] border border-yellow-100 flex-row items-center gap-3">
              ...
              <View className="flex-1">
                <Text className="text-[13px] text-yellow-800 font-medium">
                ...
                >
                  <Text className="text-[12px] text-system-blue-light font-bold mt-1">
                    Setup PIN now →
                  </Text>
                </Pressable>
              </View>
