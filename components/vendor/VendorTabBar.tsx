...
const TABS = [
  { name: "index", label: "Home", Icon: VendorHomeIcon },
  { name: "products", label: "Products", Icon: ProductIcon },
  { name: "orders", label: "Orders", Icon: OrderIcon },
        ...
        return (
          ...
          >
            <View style={styles.iconContainer}>
              <tab.Icon active={isFocused} color={color} size={22} />
